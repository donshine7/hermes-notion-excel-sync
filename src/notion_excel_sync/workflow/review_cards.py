    ...
    for number, operation in enumerate(main_operations, start=1):
        ...
        cards.append(
            ReviewCard(
                ...
                summary=_summary(operation, case_number),
                ...
                knowledge_refs=knowledge_refs,
                wiki_impact=_wiki_impact(operation),
...
def review_card_page(
    ...
    *,
    ...
    return ReviewCardPage(
        ...
        unmerged_history_operations=history_count - merged_history_count,
        next_command=(
...
def _summary(operation: ProposalOperation, case_number: str) -> str:
    change = operation.change
    return (
...
def _wiki_impact(operation: ProposalOperation) -> str:
